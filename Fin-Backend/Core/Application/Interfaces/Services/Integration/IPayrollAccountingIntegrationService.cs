...
namespace FinTech.Core.Application.Interfaces.Services.Integration
{
    ...
    {
        Task ProcessSalaryPaymentAsync(string employeeId, decimal grossAmount, decimal taxAmount, decimal pensionAmount, decimal otherDeductions, string payPeriod, string reference, string description);
        ...
        Task ProcessBonusPaymentAsync(string employeeId, decimal amount, string reference, string description);
