...
using FinTech.Core.Application.DTOs.Notification;
using ClientPortalDtos = FinTech.Core.Application.DTOs.ClientPortal;
    ...
    public class ClientAuthService : IClientAuthService
    {
        ...
        public async Task<BaseResponse<LoginResponse>> ClientLoginAsync(LoginRequest request, string ipAddress, string userAgent, string deviceId)
        {
            try
            {
                ...
                return BaseResponse<LoginResponse>.SuccessResponse(loginResponse, requiresTwoFactor ? "Two-factor authentication required" : "Login successful");
            }
            catch (Exception ex)
            {
        ...
        public async Task<BaseResponse<string>> RefreshTokenAsync(string refreshToken, string ipAddress)
        {
            try
            {
                ...
                return BaseResponse<string>.SuccessResponse(jwt, "Token refreshed successfully");
            }
            catch (Exception ex)
            {
        ...
        public async Task<BaseResponse<bool>> ValidateClientSessionAsync(string customerId, string sessionToken)
        {
            try
            {
                ...
                return BaseResponse<bool>.SuccessResponse(true, "Session is valid");
            }
            catch (Exception ex)
            {
        ...
        public async Task<BaseResponse<bool>> SendPasswordResetLinkAsync(string email)
        {
            try
            {
                ...
                await _notificationService.CreateNotificationAsync(new ClientPortalDtos.CreateNotificationDto
                {
                    ...
                    DeliveryChannels = new[] { FinTech.Core.Domain.Enums.Notifications.NotificationChannel.Email }
                });
        ...
        public async Task<BaseResponse<bool>> ResetPasswordAsync(string email, string token, string newPassword)
        {
            try
            {
                ...
                return BaseResponse<bool>.SuccessResponse(true, "Password has been reset successfully.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<BaseResponse<bool>> VerifyTwoFactorCodeAsync(string customerId, string code)
        {
            ...
            if (result)
            {
                return BaseResponse<bool>.SuccessResponse(true, "Two-factor code verified successfully.");
            }
        ...
        public async Task<BaseResponse<bool>> SendTwoFactorCodeAsync(string customerId, string method)
        {
            ...
            var notificationDto = new ClientPortalDtos.CreateNotificationDto
            {
                CustomerId = customerId,
            ...
            {
                notificationDto.DeliveryChannels = new[] { FinTech.Core.Domain.Enums.Notifications.NotificationChannel.Email };
            }
            else if (method.Equals("SMS", StringComparison.OrdinalIgnoreCase))
            {
                notificationDto.DeliveryChannels = new[] { FinTech.Core.Domain.Enums.Notifications.NotificationChannel.SMS };
            }
            else
            {
            ...
            return BaseResponse<bool>.SuccessResponse(true, $"A two-factor authentication code has been sent to your {method}.");
        }
    }
}
