-- Migration: Add Cooperative Loan Management Entities
-- Date: 2024-11-30
-- Description: Creates tables for cooperative loan management system
...
PRINT 'Cooperative Loan Management tables created successfully';
