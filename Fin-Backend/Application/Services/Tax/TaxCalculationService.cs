...
namespace FinTech.Core.Application.Services.Helpers
{
    // Small helper payroll tax calculator moved to helpers namespace to avoid conflict
    ...
    public class PayrollTaxCalculator : IPayrollTaxCalculator
    {
