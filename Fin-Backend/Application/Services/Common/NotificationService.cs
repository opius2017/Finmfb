...
namespace FinTech.Core.Application.Services
{
    ...
    public class NotificationService : INotificationService
    {
        ...
        public async Task<NotificationDto> CreateNotificationAsync(CreateNotificationDto notificationDto)
        {
            try
            {
                ...
                if (notificationDto.DeliveryChannels != null && 
                    notificationDto.DeliveryChannels.Any(c => c != FinTech.Core.Domain.Enums.Notifications.NotificationChannel.InApp))
                {
        ...
        private string GetRecipientForChannel(Domain.Entities.Customers.Customer customer, FinTech.Core.Domain.Enums.Notifications.NotificationChannel channel)
        {
            switch (channel)
            {
                case FinTech.Core.Domain.Enums.Notifications.NotificationChannel.Email:
                    return customer.Email;
                case FinTech.Core.Domain.Enums.Notifications.NotificationChannel.SMS:
                    return customer.PhoneNumber;
                case FinTech.Core.Domain.Enums.Notifications.NotificationChannel.Push:
        ...
        private FinTech.Core.Domain.Enums.Notifications.NotificationChannel[] GetChannelsFromTemplate(NotificationTemplate template)
        {
            var channels = new List<FinTech.Core.Domain.Enums.Notifications.NotificationChannel>();

            if (template.RequiresInApp)
                channels.Add(FinTech.Core.Domain.Enums.Notifications.NotificationChannel.InApp);
            if (template.RequiresEmail)
                channels.Add(FinTech.Core.Domain.Enums.Notifications.NotificationChannel.Email);
            if (template.RequiresSms)
                channels.Add(FinTech.Core.Domain.Enums.Notifications.NotificationChannel.SMS);
            if (template.RequiresPush)
                channels.Add(FinTech.Core.Domain.Enums.Notifications.NotificationChannel.Push);
