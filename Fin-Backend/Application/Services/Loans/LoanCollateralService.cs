...
namespace FinTech.Core.Application.Services.Loans
{
    ...
    {
        private readonly FinTech.Core.Application.Interfaces.Repositories.Loans.ILoanCollateralRepository _collateralRepository;
        private readonly ILoanRepository _loanRepository;
        private readonly ILogger<LoanCollateralService> _logger;

        public LoanCollateralService(
            FinTech.Core.Application.Interfaces.Repositories.Loans.ILoanCollateralRepository collateralRepository,
