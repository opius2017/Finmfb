    ...
    public class MfaNotificationService : IMfaNotificationService
    {
        ...
        public async Task SendMfaSetupSuccessEmailAsync(string userId, string username, string email)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Failed to send MFA setup success email to user {UserId}: {Message}", userId, result.Message);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SendNewLoginNotificationAsync(string userId, string email, string ipAddress, string deviceInfo, string location)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Failed to send new login notification email to user {UserId}: {Message}", userId, result.Message);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SendSuspiciousActivityAlertAsync(string userId, string email, string activityType, string ipAddress, string deviceInfo, string location)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Failed to send suspicious activity alert email to user {UserId}: {Message}", userId, result.Message);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SendBackupCodesGeneratedEmailAsync(string userId, string username, string email)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Failed to send backup codes generated email to user {UserId}: {Message}", userId, result.Message);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SendSecurityPreferencesUpdatedEmailAsync(string userId, string email)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Failed to send security preferences updated email to user {UserId}: {Message}", userId, result.Message);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SendTrustedDeviceAddedEmailAsync(string userId, string email, string deviceInfo)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Failed to send trusted device added email to user {UserId}: {Message}", userId, result.Message);
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task SendTrustedDeviceRemovedEmailAsync(string userId, string email, string deviceInfo)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Failed to send trusted device removed email to user {UserId}: {Message}", userId, result.Message);
                }
            }
            catch (Exception ex)
            {
