...
namespace FinTech.Application.DTOs.ClientPortal
{
    ...
    public class SupportTicketMappingProfile
    {
        ...
        public static ClientSupportTicketDto MapToDto(FinTech.Domain.Entities.ClientPortal.ClientSupportTicket ticket)
        {
            if (ticket == null)
                return null;
        ...
        public static ClientSupportMessageDto MapToDto(FinTech.Domain.Entities.ClientPortal.ClientSupportMessage message)
        {
            if (message == null)
                return null;
        ...
        public static KnowledgeBaseArticleDto MapToDto(FinTech.Domain.Entities.ClientPortal.KnowledgeBaseArticle article)
        {
            if (article == null)
                return null;
        ...
        public static KnowledgeBaseCategoryDto MapToDto(FinTech.Domain.Entities.ClientPortal.KnowledgeBaseCategory category)
        {
            if (category == null)
                return null;
        ...
        public static FAQDto MapToDto(FinTech.Domain.Entities.ClientPortal.FrequentlyAskedQuestion faq)
        {
            if (faq == null)
                return null;
