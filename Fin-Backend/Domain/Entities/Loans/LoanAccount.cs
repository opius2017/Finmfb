...
public class LoanAccount : BaseEntity
{
    ...
    // Backward-compatible alias expected by Application layer
    ...
    // Compatibility alias (older code expects Tenor)
    public int Tenor
    {
        get => TenorDays;
        set => TenorDays = value;
    ...
    // Backward-compatible computed property for outstanding balance
    public decimal OutstandingBalance
    {
        get => OutstandingPrincipal + OutstandingInterest + OutstandingFees;
        set => OutstandingPrincipal = value; // best-effort assignment
    }
}
