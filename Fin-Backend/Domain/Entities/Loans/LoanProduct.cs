...
namespace FinTech.Core.Domain.Entities.Loans
{
    public class LoanProduct : BaseEntity
    {
        ...
        // Backward-compatible property names expected by Application layer
        ...
        {
            get => MinInterestRate;
            set => MinInterestRate = value;
        }

        public int MinimumTenor
        {
            get => MinTermMonths;
            set => MinTermMonths = value;
        }

        public int MaximumTenor
        {
            get => MaxTermMonths;
            set => MaxTermMonths = value;
        }
