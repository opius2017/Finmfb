...
namespace FinTech.Core.Domain.Entities.FixedAssets
{
    ...
    public class AssetDepreciationSchedule : BaseEntity
    {
        ...
        // Aliases for book value properties
        public decimal BookValueBeforeDepreciation
        {
            get => OpeningBookValue;
            set => OpeningBookValue = value;
        }
        
        public decimal BookValueAfterDepreciation
        {
            get => ClosingBookValue;
            set => ClosingBookValue = value;
        }
        
        public string CreatedById { get; set; }
        
        // PostedToGL is an alias for IsPosted
