...
// Money type is referenced explicitly to avoid ambiguity between ValueObjects and Entities.Common
...
namespace FinTech.Core.Domain.Entities.Accounting
{
    ...
    {
        // Make setters public / add writable compatibility for Application layer initializers
        ...
        public string ReversalJournalEntryId { get; set; }
        ...
        // Provide a writable collection property to support object initializer usage in Application layer
        public List<JournalEntryLine> JournalEntryLines
        {
            get => _journalEntryLines;
            set => _journalEntryLines = value ?? new List<JournalEntryLine>();
        }
        
        // Required by EF Core and also used by Application initializers
        public JournalEntry() { }
        ...
        public void AddJournalLine(
            string accountId,
            FinTech.Core.Domain.ValueObjects.Money amount,
            bool isDebit,
    ...
    {
        // Make setters public so Application object-initializers work
        public string JournalEntryId { get; set; }
        public string AccountId { get; set; }
        public ChartOfAccount Account { get; set; }
        public FinTech.Core.Domain.ValueObjects.Money Amount { get; set; }
        public bool IsDebit { get; set; }
        public string Description { get; set; }
        public string Reference { get; set; }

        // Compatibility properties expected by Application layer
        // When Application sets DebitAmount/CreditAmount via object initializer, map to Money + IsDebit
        public decimal DebitAmount
        {
            get => (IsDebit && Amount != null) ? Amount.Amount : 0m;
            set
            {
                Amount = FinTech.Core.Domain.ValueObjects.Money.Create(value);
                IsDebit = true;
            }
        }
