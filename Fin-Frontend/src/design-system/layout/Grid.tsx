...
export const GridItem: React.FC<GridItemProps> = ({
  ...
  return (
    <div
      className={clsx(
        spanMap[span],
        responsive?.sm && responsiveSpanMap.sm[responsive.sm],
        responsive?.md && responsiveSpanMap.md[responsive.md],
        responsive?.lg && responsiveSpanMap.lg[responsive.lg],
        responsive?.xl && responsiveSpanMap.xl[responsive.xl],
        className
      )}
    >
      {children}
